...
alias pip='pip3'
alias gs='git status'
alias upm='xrandr --output DisplayPort-0 --off'
alias pm='xrandr --output DisplayPort-0 --auto && xrandr --output DisplayPort-0 --above eDP'
alias pairpods='bluetoothctl connect 00:C5:85:E1:9C:45'
...
alias vi='nvim'
alias unzip-latest='unzip "$(ls -t | head -n 1)"'
